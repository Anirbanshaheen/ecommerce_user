...
import 'package:ecommerce_user/pages/product_list_page.dart';
...
class _CheckoutPageState extends State<CheckoutPage> {
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('$takaSymbol${_cartProvider.cartItemsTotalPrice}',
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text('$takaSymbol${_orderProvider.orderConstantsModel
                            .deliveryCharge}', style: TextStyle(fontSize: 20,
                            fontWeight: FontWeight.bold,
                            color: Colors.black),)
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text('Discount(${_orderProvider.orderConstantsModel
                            .discount}%)'),
                        Text('-$takaSymbol${_orderProvider.getDiscountAmount(
                            _cartProvider.cartItemsTotalPrice)}',
                          style: TextStyle(fontSize: 20,
                              fontWeight: FontWeight.bold,
                              color: Colors.black),)
                      ],
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text('$takaSymbol${_orderProvider.getTotalVatAmount(
                            _cartProvider.cartItemsTotalPrice)}',
                          style: TextStyle(fontSize: 20,
                              fontWeight: FontWeight.bold,
                              color: Colors.black),)
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text('$takaSymbol${_orderProvider.getGrandTotal(
                            _cartProvider.cartItemsTotalPrice)}',
                          style: TextStyle(fontSize: 20,
                              fontWeight: FontWeight.bold,
                              color: Colors.black),)
                ...
                const Text(
                  'Set Delivery Address', style: TextStyle(fontSize: 20),),
                const Divider(height: 1, color: Colors.black,),
                Padding(
                ...
                const Text(
                  'Select Payment Method', style: TextStyle(fontSize: 20),),
                const Divider(height: 1, color: Colors.black,),
                Row(
                  children: [
                    Radio<String>(
  ...
  void _saveOrder() {
    ...
    final orderModel = OrderModel(timestamp: Timestamp.now(),
